...
CLASS lhc_travel IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA :
      entity           TYPE STRUCTURE FOR CREATE ZRAP100_R_TravelTP_103,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav103 FIELDS MAX( travel_id ) AS travelID INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtrav103 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF ZRAP100_R_TravelTP_103 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_103 IN LOCAL MODE
      ENTITY Travel
...
*    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_103.
...
*
*    " set action result  internal table을 만든 것
...
**************************************************************************
 METHOD copyTravel.
    DATA:
      travels       TYPE TABLE FOR CREATE zrap100_r_traveltp_103\\travel.
